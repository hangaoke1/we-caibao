...
export default {
  ...
  methods: {
    ...
    aiChoose (type) {
      ...
      switch (type){
        ...
        case 'twoDirect':
          ...
          return [[twoBall[0]], [twoBall[1]]]
          break;
        case 'threeDirect':
          const threeBall = getRandomArrayElements(list, 3)
          return [[threeBall[0]], [threeBall[1]], [threeBall[2]]]
          break;
        case 'twoGroupPoly':
          return getRandomArrayElements(list, 2)
          break;
    ...
    genSelect(type, value) {
      if (['onePoly', 'twoPoly', 'threePoly', 'fourPoly', 'fivePoly', 'sixPoly', 'sevenPoly', 'eightPoly'].includes(type)) {
        return value.join(' ')
      }
      if (type === 'twoDirect') {
