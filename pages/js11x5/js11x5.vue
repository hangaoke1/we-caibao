<template>
  <view class="u-js">
    ...
    <view class="u-panel flex align-center justify-between" @click.stop="handleShowMore">
      <view class="u-panel-left flex align-center">
        <text class="font-s-24">{{ info.upIssue }}期</text>
        <view class="u-ball-wrap">
          <view class="u-ball f-26 white-1" v-for="item in info.upDrawNumberArr" :key="item">
            {{ item }}
          </view>
        </view>
      </view>
    ...
    <view v-show="show">
      <view class="u-panel-content" v-for="item in oldList" :key="item.issue">
        <view class="u-panel-left flex align-center">
          <text class="font-s-24">{{ item.issue }}期</text>
          <view class="u-ball-wrap">
            <view class="u-ball f-26 white-1" v-for="subItem in item.drawNumberArr" :key="subItem">
              {{ subItem }}
            </view>
          </view>
        </view>
    ...
    <view class="u-type">
      <view class="u-choose-list">
        <view
          :class="{ 'z-active': item == type }"
          class="u-choose-item f-28"
          v-for="item in typeList"
          :key="item"
          @click.stop="handleTypeChange(item)"
        >
          {{ infoMap[item].name }}
        </view>
      </view>
    ...
    <view class="u-xuan">
      ...
      <view class="u-hao-list" v-if="isRenxuan">
        <view
          class="u-hao-item"
          :class="{ 'z-active-ball': chooseList.includes(item) }"
          v-for="item in ballList"
          :key="item"
          @click.stop="handleBallClick(item)"
        >
          {{ item }}
        </view>
      </view>
      ...
      <view class="u-hao-list" v-if="type === 'twoGroupPoly'">
        <view
          class="u-hao-item"
          :class="{ 'z-active-ball': zuxuan2.includes(item) }"
          v-for="item in ballList"
          :key="item"
          @click.stop="handlezuxuan2(item)"
        >
          {{ item }}
        </view>
      </view>
      ...
      <view class="u-hao-list" v-if="type === 'threeGroupPoly'">
        <view
          class="u-hao-item"
          :class="{ 'z-active-ball': zuxuan3.includes(item) }"
          v-for="item in ballList"
          :key="item"
          @click.stop="handlezuxuan3(item)"
        >
          {{ item }}
        </view>
      </view>
      ...
      <template v-if="type === 'twoDirect'">
        <view class="u-hao-list">
          ...
          <view
            class="u-hao-item"
            :class="{ 'z-active-ball': zhixuan2[0].includes(item) }"
            v-for="item in ballList"
            :key="item"
            @click.stop="handlezhixuan2(item, 0)"
          >
            {{ item }}
          </view>
        </view>
        <view class="u-hao-list">
          ...
          <view
            class="u-hao-item"
            :class="{ 'z-active-ball': zhixuan2[1].includes(item) }"
            v-for="item in ballList"
            :key="item"
            @click.stop="handlezhixuan2(item, 1)"
          >
            {{ item }}
          </view>
        </view>
      ...
      <template v-if="type === 'threeDirect'">
        <view class="u-hao-list">
          ...
          <view
            class="u-hao-item"
            :class="{ 'z-active-ball': zhixuan3[0].includes(item) }"
            v-for="item in ballList"
            :key="item"
            @click.stop="handlezhixuan3(item, 0)"
          >
            {{ item }}
          </view>
        </view>
        <view class="u-hao-list">
          ...
          <view
            class="u-hao-item"
            :class="{ 'z-active-ball': zhixuan3[1].includes(item) }"
            v-for="item in ballList"
            :key="item"
            @click.stop="handlezhixuan3(item, 1)"
          >
            {{ item }}
          </view>
        </view>
        <view class="u-hao-list">
          ...
          <view
            class="u-hao-item"
            :class="{ 'z-active-ball': zhixuan3[2].includes(item) }"
            v-for="item in ballList"
            :key="item"
            @click.stop="handlezhixuan3(item, 2)"
          >
            {{ item }}
          </view>
        </view>
...
export default {
  ...
  methods: {
    ...
    genSelect() {
      ...
      if (this.type === 'threeDirect') {
        return [
          this.zhixuan3[0].join(' '),
          this.zhixuan3[1].join(' '),
          this.zhixuan3[2].join(' ')
        ].join('-');
      }
      if (this.type === 'twoGroupPoly') {
