...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/index/index"],{"3bbd":function(t,n,e){"use strict";(function(t,o){Object.defineProperty(n,"__esModule",{value:!0}),n.default=void 0;var i=u(e("182e"));function u(t){return t&&t.__esModule?t:{default:t}}var c=function(){return e.e("components/invinbg-image-cropper/invinbg-image-cropper").then(e.bind(null,"4ffc"))},a=function(){return e.e("components/uni-popup/uni-popup").then(e.bind(null,"915f"))},s={data:function(){return{suggest:"",version:"",tempFilePath:"",cropFilePath:"",count:0}},components:{ImageCropper:c,uniPopup:a},created:function(){var t=this;plus.runtime.getProperty(plus.runtime.appid,function(n){t.version=n.version})},onNavigationBarButtonTap:function(){this.open()},methods:{open:function(){this.$refs.popup.open()},close:function(){this.$refs.popup.close()},handleSubmitSuggest:function(){this.suggest.indexOf("9527")>-1?(0,i.default)(!0):t.showToast({title:"感谢您的反馈",icon:"none"}),this.close()},handleClick:function(){10===this.count?((0,i.default)(!0),this.count=0):this.count+=1},save:function(){this.cropFilePath?t.saveImageToPhotosAlbum({filePath:this.cropFilePath,success:function(){t.showToast({title:"保存成功"})}}):t.showToast({title:"请先上传图片"})},upload:function(){var n=this;t.chooseImage({count:1,sizeType:["original","compressed"],sourceType:["album"],success:function(t){n.tempFilePath=t.tempFilePaths.shift()}})},confirm:function(t){this.tempFilePath="",this.cropFilePath=t.detail.tempFilePath},cancel:function(){console.log(o("canceled"," at pages/index/index.vue:106"))}}};n.default=s}).call(this,e("6e42")["default"],e("0de9")["default"])},5112:function(t,n,e){"use strict";e.r(n);var o=e("f37d"),i=e("e754");for(var u in i)"default"!==u&&function(t){e.d(n,t,function(){return i[t]})}(u);e("e969");var c,a=e("f0c5"),s=Object(a["a"])(i["default"],o["b"],o["c"],!1,null,null,null,!1,o["a"],c);n["default"]=s.exports},d45a:function(t,n,e){},e754:function(t,n,e){"use strict";e.r(n);var o=e("3bbd"),i=e.n(o);for(var u in o)"default"!==u&&function(t){e.d(n,t,function(){return o[t]})}(u);n["default"]=i.a},e969:function(t,n,e){"use strict";var o=e("d45a"),i=e.n(o);i.a},f37d:function(t,n,e){"use strict";var o,i=function(){var t=this,n=t.$createElement;t._self._c},u=[];e.d(n,"b",function(){return i}),e.d(n,"c",function(){return u}),e.d(n,"a",function(){return o})},f3ba:function(t,n,e){"use strict";(function(t){e("1fbc"),e("921b");o(e("66fd"));var n=o(e("5112"));function o(t){return t&&t.__esModule?t:{default:t}}t(n.default)}).call(this,e("6e42")["createPage"])}},[["f3ba","common/runtime","common/vendor"]]]);
});
